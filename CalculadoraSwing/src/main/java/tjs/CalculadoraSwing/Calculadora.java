...
import tjs.CalculadoraSwing.Calc;
...
public class Calculadora extends JFrame {
	 ...
	 //CONSTRUCTOR   
	  ...
	  //1. CREAMOS EL FRAME
	  frame = new JFrame("");//ESTE ES EL NOBRE DE FRAME EL QUE SE UBICA EN LA PARTE DE ARRIBA DEL FORMULARIO
	 ...
	 //ADCIONAMOS LOS BOTONES EL PANEL
	  ...
	  B_c.addActionListener(new ActionListener(){//BOTON QUE REALIZA LA OPERACION  DE BORRAR LOS NUMEROS QUE APARECEN EN LA CAJA DE  TEXTO
	   public void actionPerformed(ActionEvent e){
	     acum="";
	  ...
	  frame.setSize(371, 443);// TAMAÑO EL FORMULARIO O FRAME
